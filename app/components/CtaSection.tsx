...
export default function CtaSection() {
  return (
    <section className="relative w-full max-w-[1214px] min-h-[280px] h-auto md:h-[280px] rounded-2xl overflow-hidden mx-auto mt-10">
      {/* Background image */}
      <Image
      ...
      {/* Content with proper padding on both sides */}
      <div className="relative z-10 h-full flex flex-col justify-center items-center md:items-start px-8 sm:px-12 lg:px-16 py-8 md:py-0 text-white text-center md:text-left">
